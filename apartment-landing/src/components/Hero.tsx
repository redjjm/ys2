...
// 이미지 파일들을 import로 가져옵니다
import pers1 from '../image/perspective/pers-1.jpg';
import pers2 from '../image/perspective/pers-2.jpg';
import pers3 from '../image/perspective/pers-3.jpg';
import pers4 from '../image/perspective/pers-4.jpg';
import pers5 from '../image/perspective/pers-5.jpg';
import pers6 from '../image/perspective/pers-6.jpg';
import pers7 from '../image/perspective/pers-7.jpg';
import cafeIconImg from '../image/button/naver-cafe-icon.png';
import kakaochatIconImg from '../image/button/kakaotalk-icon.png';
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-16 portrait:left-1/2 portrait:transform portrait:-translate-x-1/2 landscape:right-10 z-10 flex flex-row gap-4">
        ...
        >
          <img src={cafeIconImg} alt="공식 카페 아이콘" className="w-6 h-6 mr-2" />
          <span>카페 입장</span>
        </button>
        <button 
        ...
        >
          <img src={kakaochatIconImg} alt="오픈 채팅 아이콘" className="w-6 h-6 mr-2" />
          <span>채팅 입장</span>
        </button>
      </div>
    </section>
